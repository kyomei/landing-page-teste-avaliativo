...
<header id="header" class="d-none"> 
	<nav id="menu">
      ...
      <div class="navbar-header d-flex-between">
         <a href="#">D.L.B</a>
...
<header id="header-teste" class="d-flex-center"> 
   <div class="container-flex d-flex-column">
      <nav id="navbar">
         MENU
	...
	<div class="contato-container">
		<div class="contato-info">
			...
			<form method="POST">
				...
				<textarea name="mensagem" placeholder="Mensagem" row="8" col="15"></textarea>
            <input type="submit" value="Enviar" />
			</form>
		</div>
      <div class="contato-img">fasdfdas<br>fdafds</div>
	</div>
</section>
<!-- End .\ Contato -->
...
<footer id="footer" class="d-flex-center">
   <div class="container d-flex-between-center">      
      <!-- Copyright -->
